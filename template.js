...
var addName = document.getElementById('input-name');
var addEmail = document.getElementById('input-email');
var addHomepage = document.getElementById('input-homepage');
...
var addToList = function(){
    ...
    // var newItem = new listItemObj();
    // var newItem = new listItemObj();
    newItem.content = addName.value;
    newItem.content = addEmail.value;
    newItem.content = addHomepage.value;
    listArray.push(newItem);
    console.log(listArray);
    //add to the local storage
    refreshLocal();
    //change the dom
    var name = createItemDom(addName.value,'incomplete');
    var email = createItemDom(addEmail.value,'incomplete');
    var url = createItemDom(addHomepage.value,'incomplete');
    todoList.appendChild(name);
    todoList.appendChild(email);
